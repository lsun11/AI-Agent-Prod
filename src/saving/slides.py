...
# If you have a concrete DocumentLayout type, you can import it here.
# For example:
# from ..layout_models import DocumentLayout
# For now we keep `layout` typed as `Any` to avoid import issues.
...
def save_result_slides(
    ...
    # 🔹 Main title: always the query / overall title
    ...
    # 🔹 Subtitle: use first-slide title if it exists, fallback to tagline
    subtitle_text = (
