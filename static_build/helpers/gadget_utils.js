 ...
 */
export function saveGadgetPosition(el, id) {
    if (!el)
        return;
 ...
 */
export function restoreGadgetPosition(el, id) {
    if (!el)
        return;
 ...
 */
export function bindStandardGadgetEvents(gadget, header, toggleBtn, backdrop, storageId, onExpand) {
    let hoverTimeout;
    let isPinned = false;
...
//# sourceMappingURL=gadget_utils.js.map