...
export class Desktop {
    ...
    initWeatherBehavior() {
        if (this.weatherGadgetEl && this.weatherHeaderEl && this.weatherToggleBtn && this.backdrop) {
            bindStandardGadgetEvents(this.weatherGadgetEl, this.weatherHeaderEl, this.weatherToggleBtn, this.backdrop, "weather-gadget", () => { var _a; return void ((_a = this.weather) === null || _a === void 0 ? void 0 : _a.refresh(false)); });
        }
    }
    initFilesBehavior() {
        if (this.filesGadgetEl && this.filesHeaderEl && this.filesToggleBtn && this.backdrop) {
            bindStandardGadgetEvents(this.filesGadgetEl, this.filesHeaderEl, this.filesToggleBtn, this.backdrop, "files-gadget", () => { var _a; return (_a = this.files) === null || _a === void 0 ? void 0 : _a.refresh(); });
        }
    }
    initClockBehavior() {
        if (this.clockGadgetEl && this.clockHeaderEl && this.clockToggleBtn && this.backdrop) {
            bindStandardGadgetEvents(this.clockGadgetEl, this.clockHeaderEl, this.clockToggleBtn, this.backdrop, "clock-gadget");
        }
    }
    initStockBehavior() {
